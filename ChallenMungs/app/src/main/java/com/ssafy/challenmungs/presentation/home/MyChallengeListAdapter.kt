...
import com.ssafy.challenmungs.presentation.challenge.ChallengeListAdapter

class MyChallengeListAdapter(private val data: List<Map<String, Any>>) : RecyclerView.Adapter<MyChallengeListViewHolder>() {
