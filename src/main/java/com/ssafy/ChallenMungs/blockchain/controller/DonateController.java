...
public class DonateController {
    ...
    ResponseEntity<Object> addCollectAmount(@RequestParam int campaignId,@RequestParam int money,@RequestParam String memo, @RequestParam String loginId) {
        service.addCollectAmount(campaignId,money,memo,loginId);
