...
public class PlaceController {
    ...
    public Page<Place> getPlace(@PageableDefault(size = 300) Pageable pageable, @RequestParam(value = "cities", required = false) List<String> cities, @RequestParam(required = false) String type){
