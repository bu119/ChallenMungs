        ...
        for (Challenge c : challenges) {
            ...
            if (c.getStatus() == 0 && c.getStartDate().equals(today)) {
                ...
                if (c.getChallengeType() == 2) {
                    ...
                    System.out.println(getDistance(c.getLeftTopLat(), c.getRightBottomLng(), c.getRightBottomLat(), c.getRightBottomLng()) + " " + (cell_size / 1000));
                    ...
                    panelSocketHandler.challengeManager.put(c.getChallengeId(), ChallengeVo.builder().players(new ArrayList<PlayerVo>()).mapInfo(new int [xd] [yd]).build());
